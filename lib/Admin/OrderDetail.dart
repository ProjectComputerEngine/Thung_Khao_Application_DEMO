...
import './Backend/UpdateOrderBackEnd.dart';
...
class OderDetailStatus extends State<OrderDetail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: MenuNavigation(page: 4,),
      body: Form(
          child: Container(
                          ...
                          Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(SUM.toString()),
                                  AcessToStatus(
                                    update: ()=>updateStatus(context,1,widget.id),
                                    TextStatusINButton: 'เข้าสู่สถานะรอโอน',
                                  ),
                                  AcessToStatus(
                                    update: ()=>updateStatus(context,2,widget.id),
                                    TextStatusINButton: 'เข้าสู่สถานะรอส่ง',
                                  ),
                                  AcessToStatus(
                                    update: ()=>updateStatus(context,3,widget.id),
                                    TextStatusINButton: 'เข้าสู่สถานะสำเร็จ',
                                  ),
                                  AcessToStatus(
                                    update: ()=>updateStatus(context,4,widget.id),
                                    TextStatusINButton: 'เข้าสู่สถานะยกเลิก',
                                  ),
                                  AcessToStatus(
                                    update: ()=>updateStatus(context,5,widget.id),
                                    TextStatusINButton: 'เข้าสู่สถานะคืนสินค้า',
                                  ),
                                ],
                              )),
                        ],
